 ...
 * @author Lenovo
 */
/*resolvi esse exercício exatamente igual ao 8 pois entendi que são idênticos 
ou ao menos muito parecidos*/
public class Exe18vetorVerificaNum2 {

   static Scanner leitor = new Scanner(System.in);
    static Random aleatorio = new Random();

    public static void main(String[] args) {
        System.out.println("**PROCURANDO UM NÚMERO DO VETOR**");
        int tam = tamanho();
        int[] v = criaVetor(tam);
        int num = numero();
        procuraNum(v, num);
